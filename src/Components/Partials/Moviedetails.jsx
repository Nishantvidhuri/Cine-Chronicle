      ...
      <div className='bg-zinc-800'>
        ...
        >
          <nav className='w-full text-zinc-100 flex gap-5 sm:gap-10 text-sm sm:text-xl h-[10vh] items-center'>
            ...
            <a target='_blank' rel="noreferrer" href={info.details.homepage}><i className='ri-external-link-fill'></i></a>
            <a target='_blank' rel="noreferrer" href={`https://www.wikidata.org/wiki/${info.externalid.wikidata_id}`}><i className='ri-global-line'></i></a>
            <a target='_blank' rel="noreferrer" href={`https://www.imdb.com/title/${info.externalid.imdb_id}/`}>IMDB</a>
          </nav>
          ...
          <div className='w-full flex flex-col md:flex-row gap-5 mt-5'>
            ...
            <div className='content ml-0 md:ml-[5%] text-white'>
              <h1 className='text-2xl sm:text-5xl'>
                ...
                <small className='text-lg sm:text-2xl font-bold text-zinc-300'>({info.details.release_date.split('-')[0]})</small>
              </h1>
              ...
              <div className='mt-3 mb-5 flex flex-wrap gap-3 items-center'>
                <span className='rounded-full text-sm sm:text-xl font-semibold bg-yellow-500 text-white w-[5vh] sm:w-[6vh] h-[5vh] sm:h-[6vh] shadow-lg flex justify-center items-center'>
                  {(info.details.vote_average * 10).toFixed()}<sup className='text-xs sm:text-sm'>%</sup>
                </span>
                <h1 className='w-auto sm:w-[60px] font-semibold text-sm sm:text-2xl'>User Score</h1>
                <h1 className='text-sm sm:text-base'>{info.details.release_date}</h1>
